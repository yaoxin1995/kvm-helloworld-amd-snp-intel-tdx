...
#[allow(clippy::integer_arithmetic)]
const fn gen_2mb_pdt_entries_0000_0000(i: usize) -> u64 {
    gen_2mb_pdt_entries(i, 0x0000_0000)
}

#[allow(clippy::integer_arithmetic)]
const fn gen_2mb_pdt_entries_4000_0000(i: usize) -> u64 {
    gen_2mb_pdt_entries(i, 0x4000_0000)
}

#[allow(clippy::integer_arithmetic)]
const fn gen_2mb_pdt_entries_8000_0000(i: usize) -> u64 {
    gen_2mb_pdt_entries(i, 0x8000_0000)
}
...
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7de0_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7de0_0000)
}
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7dc0_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7dc0_0000)
}
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7da0_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7da0_0000)
}
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7d80_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7d80_0000)
}
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7d60_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7d60_0000)
}
#[allow(clippy::integer_arithmetic)]
const fn gen_4k_pt_entries_0x7d40_0000(i: usize) -> u64 {
    gen_4k_pt_entries(i, 0x7d40_0000)
}
...
/// Page-Directory Table for 0x0000_0000..=0x3FFF_FFFF

#[no_mangle]
#[link_section = ".entry64_data"]
pub static PDT_0000_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_2mb_pdt_entries_0000_0000; 512],
));

/// Page-Directory Table for 0x4000_0000..=0x7FFF_FFFF

#[no_mangle]
#[link_section = ".entry64_data"]
pub static PDT_4000_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_2mb_pdt_entries_4000_0000; 512],
));

/// Page-Directory Table for 0x8000_0000..=0xBFFF_FFFF
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PDT_8000_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_2mb_pdt_entries_8000_0000; 512],
));
...
/// 4k Page Table for 0x7DE0_0000..=0x7DFF_FFFF
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7DE0_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7de0_0000; 512],
));
/// 4k Page Table 
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7DC0_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7dc0_0000; 512],
));
/// 4k Page Table 
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7DA0_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7da0_0000; 512],
));
/// 4k Page Table 
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7D80_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7d80_0000; 512],
));
/// 4k Page Table 
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7D60_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7d60_0000; 512],
));
/// 4k Page Table 
#[no_mangle]
#[link_section = ".entry64_data"]
pub static PT_7D40_0000: RacyCell<AlignedPageTable> = RacyCell::new(AlignedPageTable(
    array_const_fn_init![gen_4k_pt_entries_0x7d40_0000; 512],
));
