...
use enarx_shim_kvm::pagetables::{PDPT, PDT_0000_0000,PDT_4000_0000,PDT_8000_0000,PDT_C000_0000, PML4T, PT_FFE0_0000,PT_7DE0_0000,PT_7DC0_0000,PT_7DA0_0000,PT_7D80_0000,PT_7D60_0000,PT_7D40_0000};
...
const PAYLOAD:u32 =  0x7DDD_E000u32;
...
global_asm!(
        ...
        "40:",
        ".code64",
        // here jump to the kernel code
        "mov    rax,   QWORD PTR 0x7ddde000",
        //"mov    cl,    BYTE PTR [rax]",
        "jmp rax",
        ...
        //set_table_c_bit!(cbit = "r12", "rcx" = "{PDPT}", "rdx" = "{PDT_0000_0000}", offset = 0),
        //set_table_c_bit!(cbit = "r12", "rcx" = "{PDPT}", "rdx" = "{PDT_4000_0000}", offset = 1),
        //set_table_c_bit!(cbit = "r12", "rcx" = "{PDPT}", "rdx" = "{PDT_8000_0000}", offset = 2),
        ...
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7DE0_0000}", offset = 496),
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7DC0_0000}", offset = 495),
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7DA0_0000}", offset = 494),
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7D80_0000}", offset = 493),
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7D60_0000}", offset = 492),
        set_table_c_bit!(cbit = "r12", "rcx" = "{PDT_4000_0000}", "rdx" = "{PT_7D40_0000}", offset = 491),*/


        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PDPT}"),
        /*correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PDT_0000_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PDT_4000_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PDT_8000_0000}"),*/
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PDT_C000_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_FFE0_0000}"),
        /*correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7DE0_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7DC0_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7DA0_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7D80_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7D60_0000}"),
        correct_table_c_bit!(cbit_low = "ebx", ctr = "ecx", "rdx" = "{PT_7D40_0000}"),*/
        ...
        //PDT_0000_0000 = sym PDT_0000_0000,
        //PDT_4000_0000 = sym PDT_4000_0000,
        //PDT_8000_0000 = sym PDT_8000_0000,
        PDT_C000_0000 = sym PDT_C000_0000,
        PT_FFE0_0000 = sym PT_FFE0_0000,
        /*PT_7DE0_0000 = sym PT_7DE0_0000,
        PT_7DC0_0000 = sym PT_7DC0_0000,
        PT_7DA0_0000 = sym PT_7DA0_0000,
        PT_7D80_0000 = sym PT_7D80_0000,
        PT_7D60_0000 = sym PT_7D60_0000,
        PT_7D40_0000 = sym PT_7D40_0000,*/
        INITIAL_SHIM_STACK = sym INITIAL_SHIM_STACK,
        //_PAYLOAD = const 0x7DDD_E000u32,
