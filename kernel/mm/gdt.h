...
#define USER_CODE64_ACCESS (KERNEL_CODE64_ACCESS|AC_DPL_USER)
#define USER_CODE64_FLAGS (KERNEL_CODE64_FLAGS)

#define USER_DATA_ACCESS (KERNEL_DATA_ACCESS|AC_DPL_USER)
#define USER_DATA_FLAGS (KERNEL_DATA_FLAGS)
